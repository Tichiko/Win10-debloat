...
# 2nd Tweaked Source: https://github.com/ChrisTitusTech/win10script/blob/master/win10debloat.ps1
#
#    If you're a power user looking to tweak your machines, or doing larger roll-out.. 
...
#########################
#
# Note: This script is slightly modified specifically for setting up one computer.
# Some of the programs that were added to this script were commented out for this specifc install.
#
#########################
#
##########
...
Function InstallKeepass2 {
	Write-Output "Installing Keepass 2"
...
Function InstallSteam {
	Write-Output "installing League of Legends"
	choco install steam -y
}

Function InstallTeamspeak {
	Write-Output "Installing TeamSpeak 3"
